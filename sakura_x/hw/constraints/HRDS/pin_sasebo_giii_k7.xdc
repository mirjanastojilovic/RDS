...
create_clock -period 50.000 -name lbus_clkn [get_ports lbus_clkn]
...
add_cells_to_pblock [get_pblocks pblock_SENSOR] [get_cells {sensor_fifo sensor_top}]
resize_pblock [get_pblocks pblock_SENSOR] -add {SLICE_X56Y214:SLICE_X97Y225}
set_property EXCLUDE_PLACEMENT 1 [get_pblocks pblock_SENSOR]
set_property LOC RAMB36_X3Y43 [get_cells {sensor_fifo/fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/gbm.gbmg.gbmga.ngecc.bmg/inst_blk_mem_gen/gnbram.gnativebmg.native_blk_mem_gen/valid.cstr/ramloop[0].ram.r/prim_noinit.ram/DEVICE_7SERIES.NO_BMM_INFO.SDP.WIDE_PRIM36_NO_ECC.ram}]
set_property LOC RAMB36_X4Y43 [get_cells {sensor_fifo/fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/gbm.gbmg.gbmga.ngecc.bmg/inst_blk_mem_gen/gnbram.gnativebmg.native_blk_mem_gen/valid.cstr/ramloop[1].ram.r/prim_noinit.ram/DEVICE_7SERIES.NO_BMM_INFO.SDP.WIDE_PRIM36_NO_ECC.ram}]
...
set_property BEL AFF [get_cells sensor_top/sensor/sensor_instance/coarse_ld_init]
set_property BEL A6LUT [get_cells sensor_top/sensor/sensor_instance/coarse_init]
set_property BEL DFF [get_cells {sensor_top/sensor/sensor_instance/pre_buf_chain_gen[31].ld_chain}]
set_property LOC SLICE_X56Y224 [get_cells sensor_top/sensor/sensor_instance/coarse_ld_init]
set_property LOC SLICE_X56Y224 [get_cells sensor_top/sensor/sensor_instance/coarse_init]
set_property LOC SLICE_X63Y224 [get_cells {sensor_top/sensor/sensor_instance/pre_buf_chain_gen[31].ld_chain}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[0].obs_regs}]
set_property LOC SLICE_X64Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[0].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[1].obs_regs}]
set_property LOC SLICE_X66Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[1].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[2].obs_regs}]
set_property LOC SLICE_X68Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[2].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[3].obs_regs}]
set_property LOC SLICE_X70Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[3].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[4].obs_regs}]
set_property LOC SLICE_X72Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[4].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[5].obs_regs}]
set_property LOC SLICE_X74Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[5].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[6].obs_regs}]
set_property LOC SLICE_X76Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[6].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[7].obs_regs}]
set_property LOC SLICE_X78Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[7].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[8].obs_regs}]
set_property LOC SLICE_X80Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[8].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[9].obs_regs}]
set_property LOC SLICE_X82Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[9].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[10].obs_regs}]
set_property LOC SLICE_X84Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[10].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[11].obs_regs}]
set_property LOC SLICE_X86Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[11].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[12].obs_regs}]
set_property LOC SLICE_X88Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[12].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[13].obs_regs}]
set_property LOC SLICE_X90Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[13].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[14].obs_regs}]
set_property LOC SLICE_X92Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[14].obs_regs}]
set_property BEL A5FF [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[15].obs_regs}]
set_property LOC SLICE_X94Y224 [get_cells {sensor_top/sensor/sensor_instance/sensor_o_regs[15].obs_regs}]
...
add_cells_to_pblock [get_pblocks others] [get_cells {FSM clk_generator i_0 mk_clkrst/u20 reset_gen}]
...
#FIX ROUTING FOR SENSOR


set_property FIXED_ROUTE { { CLBLM_L_DQ CLBLM_LOGIC_OUTS3 EL1BEG2  { FAN_ALT5 FAN_BOUNCE5 BYP_ALT1 BYP1 CLBLM_M_AX }  EL1BEG1 EL1BEG0  { BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  ER1BEG1  { FAN_ALT6 FAN_BOUNCE6 BYP_ALT1 BYP_L1 CLBLM_M_AX }  EL1BEG0  { BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  ER1BEG1  { FAN_ALT6 FAN_BOUNCE6 BYP_ALT1 BYP_L1 CLBLM_M_AX }  EL1BEG0 ER1BEG1  { FAN_ALT6 FAN_BOUNCE6 BYP_ALT1 BYP_L1 CLBLM_M_AX }  EL1BEG0  { BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  ER1BEG1 EL1BEG0  { ER1BEG1  { FAN_ALT6 FAN_BOUNCE6 BYP_ALT1 BYP_L1 CLBLL_LL_AX }  EL1BEG0  { BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  ER1BEG1  { FAN_ALT6 FAN_BOUNCE6 BYP_ALT1 BYP_L1 CLBLL_LL_AX }  EL1BEG0  { BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  ER1BEG1 EL1BEG0  { BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  ER1BEG1  { FAN_ALT6 FAN_BOUNCE6 BYP_ALT1 BYP_L1 CLBLM_M_AX }  EL1BEG0 ER1BEG1  { FAN_ALT6 FAN_BOUNCE6 BYP_ALT1 BYP_L1 CLBLM_M_AX }  EL1BEG0 BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  BYP_ALT0 BYP_BOUNCE0 BYP_ALT1 BYP1 CLBLM_M_AX }  } [get_nets {sensor_top/sensor/sensor_instance/ID_s[63]}]
