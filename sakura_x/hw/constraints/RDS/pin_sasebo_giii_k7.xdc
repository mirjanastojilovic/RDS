...
add_cells_to_pblock [get_pblocks pblock_SENSOR] [get_cells {sensor_top/ID_coarse_s_reg[*] sensor_top/ID_fine_s_reg[*] sensor_fifo/*}]
resize_pblock [get_pblocks pblock_SENSOR] -add  {SLICE_X56Y200:SLICE_X71Y249}

set_property LOC RAMB36_X3Y41 [get_cells sensor_fifo/fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/gbm.gbmg.gbmga.ngecc.bmg/inst_blk_mem_gen/gnbram.gnativebmg.native_blk_mem_gen/valid.cstr/ramloop[0].ram.r/prim_noinit.ram/DEVICE_7SERIES.NO_BMM_INFO.SDP.WIDE_PRIM36_NO_ECC.ram]
set_property LOC RAMB36_X3Y40 [get_cells sensor_fifo/fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/gbm.gbmg.gbmga.ngecc.bmg/inst_blk_mem_gen/gnbram.gnativebmg.native_blk_mem_gen/valid.cstr/ramloop[1].ram.r/prim_noinit.ram/DEVICE_7SERIES.NO_BMM_INFO.SDP.WIDE_PRIM36_NO_ECC.ram]

create_pblock pblock_REGISTERS
add_cells_to_pblock [get_pblocks pblock_REGISTERS] [get_cells sensor_top/sensor/sensor_instance/sensor_o_regs[*].obs_regs]
...
# SET SENSOR ORIGIN
set_property LOC SLICE_X56Y200 [get_cells sensor_top/sensor/sensor_instance/fine_init]
