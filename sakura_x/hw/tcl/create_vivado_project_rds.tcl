...
import_files -norecurse "$src_path/sources/AES_Comp.v" \
                        "$src_path/sources/RDS/chip_sasebo_giii_aes.v" \
                        ...
                        "$src_path/sources/RDS/sensor.vhd" \
                        "$src_path/sources/RDS/sensor_top.vhd" \
                        "$src_path/sources/RDS/sensor_wrapper_top.vhd" \
                        "$src_path/sources/RDS/counter_small.vhd" \
...
add_files -fileset constrs_1 -norecurse "$src_path/constraints/RDS/pin_sasebo_giii_k7.xdc"
import_files -fileset constrs_1 "$src_path/constraints/RDS/pin_sasebo_giii_k7.xdc"
