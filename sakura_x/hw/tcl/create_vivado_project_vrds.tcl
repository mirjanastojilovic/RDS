...
import_files -norecurse "$src_path/sources/AES_Comp.v" \
                        "$src_path/sources/VRDS/chip_sasebo_giii_aes.v" \
                        ...
                        "$src_path/sources/VRDS/sensor.vhd" \
                        "$src_path/sources/VRDS/sensor_top.vhd" \
                        "$src_path/sources/VRDS/sensor_wrapper_top.vhd" \
                        "$src_path/sources/VRDS/counter_small.vhd" \
...
add_files -fileset constrs_1 -norecurse "$src_path/constraints/VRDS/pin_sasebo_giii_k7.xdc"
import_files -fileset constrs_1 "$src_path/constraints/VRDS/pin_sasebo_giii_k7.xdc"
